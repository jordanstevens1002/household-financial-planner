...
- **10I — timeline:** one household timeline for observed history, planned decisions and projected
  estimates, using backend classifications, deterministic ordering and data-quality flags. Users
