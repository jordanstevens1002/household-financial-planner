...
Implement `PurchaseProvider` from `app.purchase_providers.base` and register an instance or class:
...
`app.purchase_providers.australia`; another provider requires no shared schema or service edits.
