...
- Borrowed funding contributes to total purchase debt and LVR.
- The desired buffer is retained as part of the required funding total.
- Loan repayments use a constant principal-and-interest rate supplied for the calculation.
- Comfort thresholds are household choices; the service does not prescribe a universal safe LVR
  or surplus.
- Provider costs and user-entered costs are shown separately and remain estimates.
