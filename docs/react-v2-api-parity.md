...
| GET, POST | `/api/v1/households/{household_id}/memberships` | Membership list and creation | #37, #38 |
| PATCH, DELETE | `/api/v1/households/{household_id}/memberships/{membership_id}` | Membership role and removal | #37, #38 |
