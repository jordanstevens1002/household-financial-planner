...
export interface paths {
    "/api/v1/admin/legacy-identities": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List Legacy Identities */
        get: operations["list_legacy_identities_api_v1_admin_legacy_identities_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/legacy-identities/review": {
        ...
        post: operations["record_migration_review_api_v1_admin_legacy_identities_review_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/legacy-identities/reviews": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Migration Review History */
        get: operations["migration_review_history_api_v1_admin_legacy_identities_reviews_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        LegacyIdentityListResponse: {
            ...
            active_review?: components["schemas"]["LegacyMigrationReviewSummary"] | null;
            /** Cutover Ready */
        ...
        LegacyIdentityMapRequest: {
            ...
            new_account?: components["schemas"]["LegacyLocalAccountCreate"] | null;
        };
        /** LegacyIdentityMappedResponse */
        LegacyIdentityMappedResponse: {
            identity: components["schemas"]["LegacyIdentityResponse"];
            /** Temporary Password */
        ...
        LegacyIdentityResponse: {
             ...
             */
            id: string;
            mapping: components["schemas"]["LegacyMappingSummary"] | null;
            /** Memberships */
        ...
        LegacyMigrationReviewHistory: {
            /** Reviews */
            reviews: components["schemas"]["LegacyMigrationReviewSummary"][];
        };
        ...
        LegacyMigrationReviewSummary: {
            ...
            reviewed_at: string;
            /**
             * Reviewed By Application User Id
             * Format: uuid
             */
...
export interface operations {
    list_legacy_identities_api_v1_admin_legacy_identities_get: {
        parameters: {
            query?: never;
            header?: {
    ...
    record_migration_review_api_v1_admin_legacy_identities_review_post: {
        parameters: {
            query?: never;
            header?: {
                "X-Development-Subject"?: string | null;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["LegacyMigrationReviewRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    migration_review_history_api_v1_admin_legacy_identities_reviews_get: {
        parameters: {
            query?: never;
            header?: {
                "X-Development-Subject"?: string | null;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["LegacyMigrationReviewHistory"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    map_legacy_identity_api_v1_admin_legacy_identities__legacy_identity_id__mapping_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["LegacyIdentityMapRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
